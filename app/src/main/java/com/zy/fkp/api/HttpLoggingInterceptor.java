        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpHeaders.hasBody(response)) {
                ...
                if (contentLength != 0) {
                    ...
                    Log.e("===========  tag","str: " + str);
                    Log.d("retrofit:", buffer.clone().readString(charset));
                }
...
//            reqBuilder.append("===>")
//                    .append(req.substring(req.indexOf(NApiManager.API_VERSION), req.indexOf("?")))
//                    .append("}")
//                    .append("    \n")
//                    .append(req);
//            com.buykee.princessmakeup.utils.Logger.d(LogTags.REQ, reqBuilder.toString());
        } catch (Exception e) {
